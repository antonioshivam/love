...
export class EffectsLayer {
  ...
  createNotes() {
    const count = window.innerWidth < 720 ? 8 : 12;
    ...
    for (let index = 0; index < count; index += 1) {
      ...
      note.style.setProperty("--opacity", random(0.12, 0.3).toFixed(2));
      note.style.setProperty("--duration", `${random(12, 20).toFixed(2)}s`);
